...
import SoposTerminal from "../itsupport/SoposTerminal";
    ...
    <>
      ...
      {searchOpen && (
        <div className="fixed bottom-12 left-0 w-[420px] h-[520px] bg-black border border-sky-400/40 shadow-[0_0_25px_#38bdf8] z-[10000] flex flex-col font-mono">
          ...
          <div className="flex-1 px-3 space-y-2">
            ...
            <SearchItem label="📁 SOPØ PROFILE" onClick={() => openApp("profile")} />
            <SearchItem label="📁 SKILLS" onClick={() => openApp("skills")} />
            <SearchItem label="📁 EXPERIENCE" onClick={() => openApp("experience")} />
            <SearchItem label="📁 CERTIFICATES" onClick={() => openApp("certs")} />
      ...
      {activeWindow && (
        <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-[99999]">
          ...
          <div className="w-[520px] h-[420px] bg-[#05070d] border border-sky-400 shadow-[0_0_30px_#38bdf8] flex flex-col font-mono">
            ...
            {/* CONTENT */}
            <div className="flex-1 p-3 text-white overflow-y-auto text-sm">

              {activeWindow === "profile" && (
                <p>
                  SOPØ — Tech explorer character. Loves systems, networking and reverse engineering UI.
                </p>
              )}

              {activeWindow === "skills" && (
                <p>
                  Windows, Linux, Networking, CLI, Troubleshooting, Hardware.
                </p>
              )}

              {activeWindow === "experience" && (
                <p>
                  Junior Support — 1 year experience in diagnostics and user support.
                </p>
              )}

              {activeWindow === "certs" && (
                <p>
                  Certificates: Networking Basics, IT Support Fundamentals.
                </p>
              )}
