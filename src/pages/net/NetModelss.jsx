...
const NetModelss = () => {
  ...
  return (
<section className="w-full min-h-screen flex items-center justify-between px-16 py-32">  
      {/* OSI */}
          ...
          <div className="flex flex-col gap-6 pl-10">
            {osiLayers.map((layer, i) => (
              ...
              >
                ...
                <div className="px-5 py-4 rounded-sm bg-sky-400/5 hover:bg-sky-400/10 transition">
          ...
          <div className="flex flex-col gap-8 pl-10">
            {tcpLayers.map((layer, i) => (
              ...
              >
                ...
                <div className="px-5 py-4 rounded-sm bg-purple-400/5 hover:bg-purple-400/10 transition">
                  <div className="text-[14px] tracking-widest">
                    {layer.name}
                  </div>
